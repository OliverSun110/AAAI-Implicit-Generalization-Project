...
train:
	...
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 1 -optim sgd -report_every 5000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 3 -optim sgd -report_every 5000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 5 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 10 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 20 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 25 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 30 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 35 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 50 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 100 -optim sgd -report_every 5000 -train_steps 100000; \
	python3 train.py -data data/datade -save_model dedata-model -gpuid 0 -rnn_size 100 -layers 1 -shuffle 1 -optim sgd -learning_rate 0.001 -batch_size 200 -optim sgd -report_every 5000 -train_steps 100000; \
